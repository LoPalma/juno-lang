...
public class ASTTest {
    ...
    private static class MockExpression implements Expression {
        ...
        private com.clikejvm.types.Type type;
        ...
        @Override
        public com.clikejvm.types.Type getType() {
            return type;
        }

        @Override
        public void setType(com.clikejvm.types.Type type) {
            this.type = type;
        }
    }
    ...
    private static class TestNodeCountVisitor implements ASTVisitor<Void> {
        ...
        public int getMockExpressionCount() { return mockExpressionCount; }
    }
