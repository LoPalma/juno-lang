    ...
    public Void visitVariableDeclaration(VariableDeclaration varDecl) {
        ...
        if (methodGenerator == null) {
            ...
            FieldVisitor fieldVisitor = classWriter.visitField(
                ...
                fieldDescriptor,
                null,
                null  // No constant value for now - we'll initialize in static initializer if needed
            );
            fieldVisitor.visitEnd();
            
            // TODO: Handle initialization in static initializer block if needed
            // For now, global variables will get default values (0, null, false)
