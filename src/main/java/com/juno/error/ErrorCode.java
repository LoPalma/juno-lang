...
public enum ErrorCode {
	...
	// Type errors - general type mismatches
	TYPE_ERROR("TypeError", true),
	TYPE_MISMATCH("TypeMismatch", true),

	// Declaration errors
	DUPLICATE_DECLARATION("DuplicateDeclaration", true),
	UNDEFINED_IDENTIFIER("UndefinedIdentifier", true),

	// Type inference errors
	TYPE_INFERENCE_ERROR("TypeInferenceError", true),
	UNINITIALIZED_AUTO("UninitializedAuto", true),

	// Variable usage errors
	UNINITIALIZED_VARIABLE("UninitializedVariable", true),

	// Function errors
	NOT_A_FUNCTION("NotAFunction", true),
	RETURN_OUTSIDE_FUNCTION("ReturnOutsideFunction", true),
	MISSING_RETURN_VALUE("MissingReturnValue", true),

	// Expression errors
	INVALID_EXPRESSION("InvalidExpression", true),
	INVALID_CAST("InvalidCast", true),
